...
from app.services import AuthService, CourseService, EnrollmentService, UserService
...
def get_current_user(token: TokenDep, db: DbSession, settings: SettingsDep) -> User:
